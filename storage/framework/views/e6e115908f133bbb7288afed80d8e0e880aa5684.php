                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="card shadow-none mb-0">
                            <div class="card-body border rounded  p-3">
                                ...
                                <a href="#!" class="btn btn-light-primary w-100 cp_link" data-link="<?php echo e($store_id['store_url']); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Click to copy Store link')); ?>">
                    ...
                    <div class="card-body border border-bottom-0 overflow-hidden rounded pb-0 table-border-style">
                        <div class="table-responsive">
                            <table class="table mb-0">
                                <thead>
                                    <tr>
                                        <th class="bg-transparent"><?php echo e(__('Product')); ?></th>
                                    ...
                                    <?php else: ?>
                                        <tr height="150px">
                                            <td class="dataTables-empty" colspan="4"> 
                                                <?php echo e(__('No data available in table.')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\esraa\OneDrive\Desktop\up\main_file\resources\views/home.blade.php ENDPATH**/ ?>