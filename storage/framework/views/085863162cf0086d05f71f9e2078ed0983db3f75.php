<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">&copy; <?php echo e(__('Copyright')); ?>  <?php echo e((App\Models\Utility::getValByName('footer_text')) ? App\Models\Utility::getValByName('footer_text') :config('app.name', 'Storego')); ?> <?php echo e(date('Y')); ?></span>
        </div>
    </div>
</footer>
<!-- Required Js -->
...
<?php endif; ?>
<?php echo $__env->yieldPushContent('script-page'); ?><?php /**PATH C:\Users\esraa\OneDrive\Desktop\up\main_file\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>