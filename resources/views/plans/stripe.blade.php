                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="" class="col-form-label">{{ __('Plan Price : ') }}<span
                                                        class="paypal-final-price">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span></label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label for=""
                                                    class="col-form-label">{{ __('Net Amount : ') }}<span
                                                        class="final-price">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}{{ $plan->price }}</span></label><br>
                                                <small class="text-xs">
