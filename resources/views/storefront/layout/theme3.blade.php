                ...
                <ul>
                    ...
                    <li class="language-header-2 set has-children has-item">
                        ...
                        <div class="menu-dropdown acnav-list">
                            <ul>
                                @foreach ($languages as $language)
                                    <li><a href="{{ route('change.languagestore', [$store->slug, $language]) }}"
                                            class="dropdown-item @if ($language == $currantLang) active-language text-primary @endif">{{ Str::upper($language) }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
