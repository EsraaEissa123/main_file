                                                ...
                                                <tr data-id="{{$key}}" id="product-variant-id-{{ $product['variant_id'] }}">
                                                        ...
                                                        @if(!empty($product['tax']))
                                                            @foreach($product['tax'] as $k => $tax)
                                                                @php
                                                                    ...
                                                                    $total_tax += $sub_tax;
                                                                @endphp
                                                                <p class="variant_tax_{{ $k }}"> {{$tax['tax_name'].' '.$tax['tax'].'%'.' ('.$sub_tax.')'}}</p>
                                                            @endforeach
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td data-label="Total">
                                                        @php
                                                            ...
                                                            $total += $totalprice;
                                                        @endphp
                                                        <p class="subtotal">{{\App\Models\Utility::priceFormat($totalprice)}}</p>
                                                    ...
                                                    <td data-label="Tax"> 
                                                        ...
                                                        @if(!empty($product['tax']))
                                                            ...
                                                            @php
                                                                ...
                                                                $total_tax += $sub_tax;
                                                            @endphp
                                                                <p class="tax_{{ $k }}"> {{$tax['tax_name'].' '.$tax['tax'].'%'.' ('.$sub_tax.')'}}</p>
                                                            @endforeach
                                                        @else
                                                            -
                                                        @endif
