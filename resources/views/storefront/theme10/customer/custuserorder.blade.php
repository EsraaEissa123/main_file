        ...
        <div class="container">
            @if($storethemesetting['enable_header_img'] == 'on')
                <div class="section-title d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{route('customer.home',$store->slug)}}" class="btn">{{__('Back to order')}}  <i class="fas fa-home"></i></a>
                </div>
            @endif
                                    ...
                                    @foreach($order_products as $key=>$product)
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td>{{App\Models\Utility::priceFormat($product->price*$product->quantity+$total_tax)}}</td>
                                            </tr>
                                        @endif
                                        @if($order->status == 'delivered' && !empty($product->downloadable_prodcut))
                                            <tr>
                                                <td>
                                                    <a data-id="{{$order->id}}" data-value="{{asset(Storage::url('uploads/downloadable_prodcut'.'/'.$product->downloadable_prodcut))}}" class="btn downloadable_prodcut">
                                                        {{__('Download')}}
                                                    </a>
                                                </td>
                                                <td>
