                            ...
                            <tbody>
                                @if (!empty($products))
                                    ...
                                    @foreach ($products['products'] as $key => $product)
                                                ...
                                                <td data-label="Tax"> 
                                                    ...
                                                    @if (!empty($product['tax']))
                                                        ...
                                                        @php
                                                            ...
                                                            $total_tax += $sub_tax;
                                                        @endphp
                                                        <span class="variant_tax_{{ $k }}">{{ $tax['tax_name'] . ' ' . $tax['tax'] . '%' . ' (' . $sub_tax . ')' }}</span>
                                                        @endforeach
                                                    @else
                                                        -
                                                    @endif
                                        ...
                                        @else
                                            <tr data-id="{{ $key }}" id="product-id-{{ $product['product_id'] }}">
                                                <td>
                                                    <span class="table-no">{{ $counter++ }}</span>
                                                </td> 
                                                <td data-label="Product">
                                                    ...
                                                    @if (!empty($product['tax']))
                                                        @foreach($product['tax'] as $k => $tax)
                                                            @php
                                                                ...
                                                                $total_tax += $sub_tax;
                                                            @endphp
                                                            <span class="tax_{{ $k }}">{{ $tax['tax_name'] . ' ' . $tax['tax'] . '%' . ' (' . $sub_tax . ')' }}</span>
                                                        @endforeach
                                                    @endif
                                                </td> 
                                                <td data-label="Total">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="checkout-box">
                                ...
                                @if ($store_settings['is_checkout_login_required'] == null || ($store_settings['is_checkout_login_required'] == 'off' && !Auth::guard('customers')->user())) 
                                    <a href="#" class="btn checkout-btn modal-target" data-modal="Checkout" id="checkout-btn">{{ __('Proceed to checkout') }}</a>
                                @else
                                    <a href="{{ route('user-address.useraddress', $store->slug) }}" class="btn">{{ __('Proceed to checkout') }}</a>
                                @endif
                            </div>    
                        </div>
                    </div>
