                                ...
                                <div class="">
                                    <address class="mb-0 text-sm">
                                        <dl class="row mt-4 align-items-center">
                                            <dt class="col-6 h6 text-sm">{{isset($store_payment_setting['custom_field_title_1']) ? $store_payment_setting['custom_field_title_1'] : ''}}</dt>
                                            <dd class="col-6 text-sm"> {{$user_details->custom_field_title_1}}</dd>
                                            <dt class="col-6 h6 text-sm">{{isset($store_payment_setting['custom_field_title_2']) ? $store_payment_setting['custom_field_title_2'] : ''}}</dt>
                                            <dd class="col-6 text-sm"> {{$user_details->custom_field_title_2}}</dd>
                                            <dt class="col-6 h6 text-sm">{{isset($store_payment_setting['custom_field_title_3']) ? $store_payment_setting['custom_field_title_3'] : ''}}</dt>
                                            <dd class="col-6 text-sm">{{$user_details->custom_field_title_3}}</dd>
                                            <dt class="col-6 h6 text-sm">{{isset($store_payment_setting['custom_field_title_4']) ? $store_payment_setting['custom_field_title_4'] :''}}</dt>
                                            <dd class="col-6 text-sm"> {{$user_details->custom_field_title_4}}</dd>
                                        </dl>
                                    </address>
                                </div>
                            </div>
